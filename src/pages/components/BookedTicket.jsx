  ...
  return (
    <StepsContainer title="Ready" step={step} totalSteps={totalSteps}>
      ...
      <div className="flex flex-col w-full justify-center gap-5">
        <div>
          <h2 className="font-[Alatsi] text-2xl md:text-[32px] m-4 text-center">
            Your Ticket is Booked!
          </h2>
          <p className="font-[Roboto] mb-4 text-center">
        ...
        <div className=" flex justify-center content-center">
          ...
          <div
            ref={ticketRef}
            className="w-[300px] h-[600px] p-4 ticket bg-cover bg-center"
          >
            <div className="flex flex-col gap-2 justify-center items-center border border-btnGreen rounded-2xl mt-2 ">
              {/* heading */}
              <div className="text-center">
                <h3 className="font-roadrage md:text-[30px]  text-3xl my-2">
                  Techember Fest ”25
                </h3>
              ...
              <div className="grid grid-cols-2 w-[235px] border border-bgdarkBorder bg-bgUserInfo gap-0 p-1 rounded-xl mb-4">
                <div className="w-full h-[55px] border-b-1 border-r-1 border-bgdarkBorder p-1 flex flex-col gap-1">
                  <h5 className="text-[8px] opacity-50">Enter your name</h5>
                  <p className="text-[10px] font-bold truncate">
                    {attendeeDetails.fullName}
                  </p>
                </div>
                <div className="w-full h-[55px] border-b-1 border-bgdarkBorder p-1 flex flex-col gap-1">
                  <h5 className="text-[8px] opacity-50 ml-1">
                    Enter your email *
                  </h5>
                  <p className="text-[10px] font-bold break-words ml-1">
                    {attendeeDetails.email}
                  </p>
                </div>
                <div className="w-full h-[55px] border-b-1 border-r-1 border-bgdarkBorder flex flex-col gap-1 p-1">
                  <h5 className="text-[8px] opacity-50">Ticket Type:</h5>
                  <p className="text-[10px] font-bold">{selectedTicket.type}</p>
                </div>
                <div className="w-full h-[55px] border-b-1 border-bgdarkBorder  flex flex-col gap-1 p-1">
                  <h5 className="text-[10px] opacity-50 ml-1">Ticket for:</h5>
                  <p className="text-[10px] font-bold ml-1">{ticketCount}</p>
                </div>
        ...
        <div className="flex flex-col-reverse md:flex-row justify-between gap-3 md:gap-8 mt-4 rounded-3xl font-[Jejumyeongjo]">
          <Button
            type="button"
            className="border border-bgRingGreen text-bgInputLightGreen md:w-[193px] w-full hover:text-white hover:bg-bgInputLightGreen"
            onClick={resetForm}
          >
            Book Another Ticket
          </Button>
          <Button
            type="button"
            className="border border-bgRingGreen text-bgInputLightGreen md:w-[387px] w-full hover:text-white hover:bg-bgInputLightGreen hover:border-0"
