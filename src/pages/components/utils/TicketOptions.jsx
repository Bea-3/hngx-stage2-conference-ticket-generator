  ...
  return (
    <div className='border-1 border-bgLightGreen p-4 rounded-3xl flex flex-col md:flex-row justify-between mt-2  gap-4 md:gap-1 '>
      ...
      { ticketType.map( (ticket) => (
        ...
        className={`border-1 border-bgLightGreen p-3 w-full md:w-[160px] hover:bg-bgHover ${ selected === ticket.type ? 'bg-bgRingGreen' : 'bg-inherit'} rounded-2xl active:bg-bgRingGreen`}>
